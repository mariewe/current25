...
<body style="background-color:#48515B; font-family: 'Poppins'; color:white">
  ...
  <div style="width:100%; height:100%; text-align:center; display:flex; align-items:center; justify-content:center">
    <div style="padding-bottom:0.67em">
      ...
      <p>Creates Spotify playlist with your 25 most recently Liked Songs.
        This playlist is automatically synced every hour.</p>
      <br />
